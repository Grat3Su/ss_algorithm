...
public class BookDaoImpl implements BookDao {
	...
	public List<Book> select() throws SQLException {
		...
		try {
			...
			while (rset.next()) {
				...
				Book book = new Book(rset.getString("isbn"), rset.getString("title"), rset.getString("author"),
						rset.getInt("price"), rset.getString("desc"), rset.getString("img"));
				result.add(book);
			}
		}
		// 동작의 성공 여부와 상관 없이 사용한 리소스들을 반환한다. 이때 얻은 순의 역순으로 반환해주자.
	...
	@Override
	public boolean del(String isbn) throws SQLException {
